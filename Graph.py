...
def Plot_Graph(y, t, ConstDictStart, ConstDict, a, b, c, d):
    ...
    axs[0][0].set_title(f'Time evolution of first integral I')
    axs[0][0].set_xlabel('Time t')
    axs[0][0].set_ylabel('Value of I')
    axs[0][0].legend()
    axs[0][0].grid(True)
    ...
    axs[1][0].set_title(f'Time evolution of angle error')
    axs[1][0].set_xlabel('Time t')
    axs[1][0].set_ylabel('Value of angle')
    axs[1][0].legend()
    axs[1][0].grid(True)
    ...
    axs[0][1].set_title(f'Time evolution of first integral F_1')
    axs[0][1].set_xlabel('Time t')
    axs[0][1].set_ylabel('Value of  F_1')
    axs[0][1].legend()
    axs[0][1].grid(True)
    ...
    axs[0][2].set_title(f'Time evolution of first integral F_2')
    axs[0][2].set_xlabel('Time t')
    axs[0][2].set_ylabel('Value of  F_2')
    axs[0][2].legend()
    axs[0][2].grid(True)
    ...
    axs[1][1].set_title(f'Time evolution of first integral F_3')
    axs[1][1].set_xlabel('Time t')
    axs[1][1].set_ylabel('Value of  F_3')
    axs[1][1].legend()
    axs[1][1].grid(True)
    ...
    axs[1][2].set_title(f'Time evolution of first integral F_4')
    axs[1][2].set_xlabel('Time t')
    axs[1][2].set_ylabel('Value of  F_4')
    axs[1][2].legend()
    axs[1][2].grid(True)
    ...
    axs2.set_title(f'Time evolution of minimum of the difference between the curvatures')
